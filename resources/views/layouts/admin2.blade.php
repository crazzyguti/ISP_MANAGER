...
<head>
    ...
    <link href='{{ asset('down/bootstrap.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/bootstrap-extend.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/asScrollable.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/animsition.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('vendor/brand-icons/css/brand-icons.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/chartist-plugin-tooltip.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/chartist.min.css') }}' rel='stylesheet'>
    <link href="{{ asset('vendor/flag-icon-css/css/flag-icon.css')}}" rel="stylesheet">
    <link href='{{ asset('vendor/jvectormap/jquery-jvectormap.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/material-design.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/site.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/skintools.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/slidePanel.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/switchery.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/v1.min.css') }}' rel='stylesheet'>
    <link href='{{ asset('down/waves.min.css') }}' rel='stylesheet'>

    <!-- Stylesheets -->
    {{-- @include('headers.style') --}}

    {{-- <link rel="stylesheet" href="{{asset('assets/global/css/v4.0_2.css')}}"> --}}
    {{-- <link rel="stylesheet" href="{{asset('vendor/bootstrap-material-design-4.1.2/dist/css/bootstrap-material-design.css')}}">
    <link href='{{ asset('down/site.min.css') }}' rel='stylesheet'>
    <link rel="stylesheet" href="{{asset('css/skintools.min.css')}}">


    <!-- Plugins -->
    <link rel="stylesheet" href="{{asset('vendor/animsition/dist/css/animsition.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/jquery-asScrollable/dist/css/asScrollable.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/switchery/dist/switchery.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/intro.js/minified/introjs.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/jquery-slidePanel/dist/css/slidePanel.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/flag-icon-css/css/flag-icon.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/Waves/dist/waves.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('vendor/chartist-plugin-tooltip/dist/chartist-plugin-tooltip.css')}}">

    <!-- Page -->
    <link rel="stylesheet" href="{{asset('js/v1.min.css')}}">

    <!-- Fonts -->
    <link rel="stylesheet" href="{{asset('vendor/material-design-iconic-font/css/material-design-iconic-font.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/brand-icons/css/brand-icons.css')}}">
    ...
    <!-- Scripts -->
    <script src="{{asset('vendor/breakpoints.js/dist/breakpoints.js')}}"></script>
    <script>
        Breakpoints();
    </script>
...
<body class="animsition dashboard">
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="nav-item hidden-sm-down" id="toggleFullscreen">
                        <a class="nav-link icon icon-fullscreen" data-toggle="fullscreen" href="index.html#"
                            role="button">
                            <span class="sr-only">Toggle fullscreen</span>
                        </a>
                    </li>
                    <li class="nav-item hidden-float">
                        <a class="nav-link icon md-search" data-toggle="collapse" href="index.html#"
                                        ...
                                        <ul class="blocks-3">
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full"
                                                        src="{{asset('assets/global/photos/view-1-150x100.jpg')}}"
                                                        alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full"
                                                        src="{{asset('assets/global/photos/view-2-150x100.jpg')}}"
                                                        alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full"
                                                        src="{{asset('assets/global/photos/view-3-150x100.jpg')}}"
                                                        alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full"
                                                        src="{{asset('assets/global/photos/view-4-150x100.jpg')}}"
                                                        alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full"
                                                        src="{{asset('assets/global/photos/view-6-150x100.jpg')}}"
                                                        alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                        ...
                                        <div class="panel-group panel-group-simple" id="siteMegaAccordion"
                                            ...
                                            <div class="panel">
                                                <div class="panel-heading" id="siteMegaAccordionHeadingOne" role="tab">
                                                    <a class="panel-title" data-toggle="collapse"
                                                        href="index.html#siteMegaCollapseOne"
                                            ...
                                            <div class="panel">
                                                <div class="panel-heading" id="siteMegaAccordionHeadingTwo" role="tab">
                                                    <a class="panel-title collapsed" data-toggle="collapse"
                                                        href="index.html#siteMegaCollapseTwo"
                                                        data-parent="#siteMegaAccordion" aria-expanded="false"
                                            ...
                                            <div class="panel">
                                                <div class="panel-heading" id="siteMegaAccordionHeadingThree"
                                                    role="tab">
                                                    <a class="panel-title collapsed" data-toggle="collapse"
                                                        href="index.html#siteMegaCollapseThree"
                                                        data-parent="#siteMegaAccordion" aria-expanded="false"
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link navbar-avatar" data-toggle="dropdown" href="index.html#"
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-online">
                                                        <img src="{{asset('assets/global/portraits/2.jpg')}}"
                                                            alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-off">
                                                        <img src="{{asset('assets/global/portraits/3.jpg')}}"
                                                            alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="pr-10">
                                                    <span class="avatar avatar-sm avatar-busy">
                                                        <img src="{{asset('assets/global/portraits/4.jpg')}}"
                                                            alt="..." />
                                                        <i></i>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/global/portraits/1.jpg')}}" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/global/portraits/2.jpg')}}" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/global/portraits/3.jpg')}}" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="card card-shadow" id="chat">
                        <div class="card-header bg-white px-0">
                            ...
                            <div class="text-right">
                                ...
                                <a class="avatar ml-10" data-toggle="tooltip" href="index.html#" data-placement="right"
                                    title="June Lane">
                        ...
                        <div class="card-block">
                            <div class="chats">
                                <div class="chat chat-left">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="index.html#" data-placement="left"
                                            title="">
                                            <img src="{{asset('assets/global/portraits/5.jpg')}}" alt="Edward Fletcher">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                                ...
                                <div class="chat">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="index.html#"
                                            data-placement="right" title="">
                                            <img src="{{asset('assets/global/portraits/4.jpg')}}" alt="June Lane">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                    ...
                    <div class="card card-shadow">
                        <div class="card-header cover overlay">
                            <div class="cover-background h-200"
                                style="background-image: url('{{asset('assets/global/photos/focus-4-960x480.webp')}}')">
                            </div>
                        </div>
    ...
    <footer class="site-footer">
        ...
        <div class="site-footer-right">
            Crafted with <i class="red-600 icon md-favorite"></i> by <a
                href="../../../themeforest.net/user/creation-studio.htm">Creation Studio</a>
        </div>
    </footer>
    <!-- Core  -->
    ...
    {{-- @include('headers.script') --}}
    <script src="{{asset('assets/global/vendor/babel-external-helpers/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/animsition/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/mousewheel/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/asscrollbar/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/asscrollable/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/ashoverscroll/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/waves/v4.0.1')}}"></script>

    <!-- Plugins -->
    <script src="{{asset('assets/global/vendor/switchery/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/intro-js/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/screenfull/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/vendor/slidepanel/v4.0.1')}}"></script>
    ...
    <!-- Scripts -->
    <script src="{{asset('assets/global/js/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/js/v4.0_2.1')}}"></script>
    <script src="{{asset('assets/global/js/v4.0_3.1')}}"></script>
    <script src="{{asset('assets/global/js/v4.0_4.1')}}"></script>
    <script src="{{asset('assets/global/js/v4.0_5.1')}}"></script>

    <script src="{{asset('assets/js/Section/v4.0.1')}}"></script>
    <script src="{{asset('assets/js/Section/v4.0_2.1')}}"></script>
    <script src="{{asset('assets/js/Section/v4.0_3.1')}}"></script>
    <script src="{{asset('assets/js/Section/v4.0_4.1')}}"></script>
    <script src="{{asset('assets/js/Plugin/v4.0_2.1')}}"></script>

    <!-- Config -->
    <script src="{{asset('assets/global/js/config/v4.0.1')}}"></script>
    <script src="{{asset('assets/js/config/v4.0.1')}}"></script>
    <script>
    ...
    <script src="{{asset('assets/js/v4.0.1')}}"></script>
    <script src="{{asset('assets/global/js/Plugin/v4.0.1')}}"></script>

    <script src="{{asset('assets/global/js/Plugin/v4.0_2.1')}}"></script>
    <script src="{{asset('assets/global/js/Plugin/v4.0_3.1')}}"></script>

    <script src="{{asset('assets/global/js/Plugin/v4.0_4.1')}}"></script>
    <script src="{{asset('assets/global/js/Plugin/v4.0_5.1')}}"></script>
    <script src="{{asset('assets/global/js/Plugin/v4.0_6.1')}}"></script>


    <script src="{{asset('assets/examples/js/dashboard/v4.0.1')}}"></script>
