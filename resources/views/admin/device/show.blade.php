            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/device/' . $device->id . '/edit') }}" title="Edit Device"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Brand </th><td> {{ $device->brand }} </td></tr><tr><th> Model </th><td> {{ $device->model }} </td></tr><tr><th> Type </th><td> {{ $device->type }} </td></tr>
                                </tbody>
                            </table>
                        </div>
