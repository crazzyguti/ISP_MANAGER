    ...
    <section class="pt-5">
        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                ...
                <a href="#" class="btn btn-primary btn-md">Start
                    tutorial
        ...
        <div class="row mt-3 wow fadeIn">
            ...
            <div class="col-lg-5 col-xl-4 mb-4">
                ...
                <div class="view overlay rounded z-depth-1">
                    <img src="{{asset('images/client/bluebg.jpg')}}" class="img-fluid" alt="">
                    <a href="#">
            ...
            <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                ...
                <p class="grey-text">Learn how to create a smart website which learns your user and reacts properly to
                    his
                    behavior.</p>
                <a href="#" class="btn btn-primary btn-md">Start tutorial
                    <i class="fas fa-play ml-2"></i>
                </a>
            </div>
            <!--Grid column-->
